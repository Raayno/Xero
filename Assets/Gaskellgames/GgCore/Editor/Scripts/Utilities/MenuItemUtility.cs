...
namespace Gaskellgames.EditorOnly
{
    ...
    public class MenuItemUtility
    {
        ...
        // Save System
        public const int SaveSystem_Priority = 128;
        public const string SaveSystem_ToolsMenu_Path = GgToolsMenu + "/Save System";
        public const string SaveSystem_WindowMenu_Path = GgWindowMenu + "/Save System";
        public const string SaveSystem_GameObjectMenu_Path = GgGameObjectMenu + "/Save System";
