...
#else
using EntityId = Gaskellgames.EntityId;
#endif
...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GgEditorCallbacks : AssetPostprocessor, ISerializationCallbackReceiver
    {
        ...
        public delegate void OnGameObjectDestroyedDelegate(EntityId entityID, GameObject parent, Scene scene);
        ...
        public delegate void OnAssetObjectDestroyedDelegate(EntityId entityID, string guid);
        ...
        private static Object EntityIdToObject(EntityId entityID)
        {
#if UNITY_6000_3_OR_NEWER
        ...
        private static void ObjectChangeEvents_CreateGameObjectHierarchy(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject newGameObject = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                createGameObjectHierarchyEvent.entityId
#else
        ...
        private static void ObjectChangeEvents_DestroyGameObjectHierarchy(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject destroyParentGo = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                destroyGameObjectHierarchyEvent.parentEntityId
#else
                destroyGameObjectHierarchyEvent.parentInstanceId
#endif
                ) as GameObject;
            
            DebugLog("OnGameObjectDestroyed: {0} in scene {1} with parent {2}",
#if UNITY_6000_4_OR_NEWER
                destroyGameObjectHierarchyEvent.entityId,
#else
                destroyGameObjectHierarchyEvent.instanceId,
#endif
                destroyGameObjectHierarchyEvent.scene.name, destroyParentGo ? destroyParentGo.name : "Root");
            OnGameObjectDestroyed?.Invoke(
                ...
                destroyGameObjectHierarchyEvent.instanceId,
#endif
                destroyParentGo, destroyGameObjectHierarchyEvent.scene);
        }
        ...
        private static void ObjectChangeEvents_ChangeGameObjectStructureHierarchy(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject gameObject = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                changeGameObjectStructureHierarchy.entityId
#else
                changeGameObjectStructureHierarchy.instanceId
#endif
                ) as GameObject;
        ...
        private static void ObjectChangeEvents_ChangeGameObjectStructure(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject gameObjectStructure = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                changeGameObjectStructure.entityId
#else
                changeGameObjectStructure.instanceId
#endif
                ) as GameObject;
        ...
        private static void ObjectChangeEvents_ChangeGameObjectParent(ref ObjectChangeEventStream stream, int index)
        {
            ...
            GameObject gameObjectChanged = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                changeGameObjectParent.entityId
#else
                changeGameObjectParent.instanceId
#endif
                ) as GameObject;
            GameObject newParentGo = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                changeGameObjectParent.newParentEntityId
#else
                changeGameObjectParent.newParentInstanceId
#endif
                ) as GameObject;
            GameObject previousParentGo = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                changeGameObjectParent.previousParentEntityId
#else
                changeGameObjectParent.previousParentInstanceId
#endif
                ) as GameObject;
        ...
        private static void ObjectChangeEvents_ChangeGameObjectOrComponentProperties(ref ObjectChangeEventStream stream, int index)
        {
            ...
            Object goOrComponent = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                changeGameObjectOrComponent.entityId
#else
                changeGameObjectOrComponent.instanceId
#endif
                );
        ...
        private static void ObjectChangeEvents_CreateAssetObject(ref ObjectChangeEventStream stream, int index)
        {
            ...
            Object createdAsset = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                createAssetObjectEvent.entityId
#else
                createAssetObjectEvent.instanceId
#endif
                );
        ...
        private static void ObjectChangeEvents_DestroyAssetObject(ref ObjectChangeEventStream stream, int index)
        {
            ...
            DebugLog("OnAssetObjectDestroyed: {0}",
#if UNITY_6000_4_OR_NEWER
                destroyAssetObjectEvent.entityId
#else
                destroyAssetObjectEvent.instanceId
#endif
                );
            OnAssetObjectDestroyed?.Invoke(
#if UNITY_6000_4_OR_NEWER
                destroyAssetObjectEvent.entityId,
#else
                destroyAssetObjectEvent.instanceId,
#endif
                destroyAssetObjectEvent.guid.ToString());
        }
        ...
        private static void ObjectChangeEvents_ChangeAssetObjectProperties(ref ObjectChangeEventStream stream, int index)
        {
            ...
            Object changeAsset = EntityIdToObject(
#if UNITY_6000_4_OR_NEWER
                changeAssetObjectPropertiesEvent.entityId
#else
                changeAssetObjectPropertiesEvent.instanceId
#endif
                );
...
#if UNITY_6000_4_OR_NEWER
            foreach (EntityId entityID in updatePrefabInstancesEvent.entityIds)
#else
            foreach (EntityId entityID in updatePrefabInstancesEvent.instanceIds)
#endif
            {
                GameObject prefabRoot = EntityIdToObject(entityID) as GameObject;
                if (!prefabRoot) { return; }

                DebugLog("OnPrefabInstanceUpdated: {0} in scene: {1}", entityID, updatePrefabInstancesEvent.scene.name);
