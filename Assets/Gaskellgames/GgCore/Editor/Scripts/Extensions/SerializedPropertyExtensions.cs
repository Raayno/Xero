...
namespace Gaskellgames.EditorOnly
{
    ...
    public static class SerializedPropertyExtensions
    {
        ...
        #region TryDrawSerializedPropertyInObject
        
        /// <summary>
        /// Uses reflection to get a SerializedProperty from an Object, so that it can be drawn in another editor / editor window. 
        /// </summary>
        /// <param name="obj"></param>
        /// <param name="propertyPath"></param>
        /// <typeparam name="T"></typeparam>
        /// <remarks>High CPU usage if used frequently!</remarks>
        public static bool TryDrawSerializedPropertyInObject<T>(this T obj, string propertyPath) where T : Object
        {
            Editor tutorialVisualiserEditor = obj != null ? Editor.CreateEditor(obj) : null;
            if (tutorialVisualiserEditor == null) { return false; }
            
            SerializedProperty property = tutorialVisualiserEditor.serializedObject.FindProperty(propertyPath);
            ...
            {
                tutorialVisualiserEditor.serializedObject.ApplyModifiedPropertiesWithoutUndo();
            }
            return true;
        }
