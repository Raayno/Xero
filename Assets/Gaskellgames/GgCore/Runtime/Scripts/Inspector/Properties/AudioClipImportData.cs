...
namespace Gaskellgames
{
    ...
    public class AudioClipImportData
    {
        ...
        [Tooltip("The AudioClip asset reference for the AudioClipImportData")]
        ...
        */
        ...
        /// <summary>
        /// AudioClipImportData caches the values of an audioClip's fileName, assetPath and import settings.
        /// New AudioClipImportData can be created at runtime, but some variables may not be correctly set if created from null or audioClip types.
        /// </summary>
        /// <param name="audioClipImportData"></param>
        public AudioClipImportData(AudioClipImportData audioClipImportData)
        {
            this.audioClip = audioClipImportData.audioClip;
            this.fileName = audioClipImportData.fileName;
            this.assetPath = audioClipImportData.assetPath;
            
            this.forceToMono = audioClipImportData.forceToMono;
            this.loadInBackground = audioClipImportData.loadInBackground;
            this.ambisonic = audioClipImportData.ambisonic;
            
            this.loadType = audioClipImportData.loadType;
            this.preloadAudioData = audioClipImportData.preloadAudioData;
            this.compressionFormat = audioClipImportData.compressionFormat;
            this.quality = audioClipImportData.quality;
            
#if UNITY_EDITOR
            this.sampleRateSetting = audioClipImportData.sampleRateSetting;
#endif
        }
        ...
        public AudioClipImportData(string fileName, string assetPath, bool forceToMono, bool loadInBackground, bool ambisonic, AudioClipLoadType loadType, bool preloadAudioData, AudioCompressionFormat compressionFormat, float quality)
        {
#if UNITY_EDITOR
...
#if UNITY_EDITOR
        internal static bool Editor_CreateAudioClipImportData(AudioClip clip, out AudioClipImportData audioClipImportData)
        {
            string filePath = UnityEditor.AssetDatabase.GetAssetOrScenePath(clip);
            if (Editor_CreateAudioClipImportData(filePath, out AudioClipImportData clipData))
            {
                audioClipImportData = clipData;
                return true;
            }
            audioClipImportData = null;
            return false;
        }
        
        public static bool Editor_CreateAudioClipImportData(string filePath, out AudioClipImportData audioClipImportData)
        {
            ...
            // return newly created AudioClipImportData
            audioClipImportData = new AudioClipImportData(fileName, assetPath, forceToMono, loadInBackground, ambisonic, loadType, preloadAudioData, compressionFormat, quality) 
            {
        ...
        /// <summary>
        /// The AudioClip asset reference for the AudioClipImportData
        /// </summary>
