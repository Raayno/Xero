...
namespace Gaskellgames
{
    ...
    [Serializable]
    public abstract class ASerializedDictionary : IEnumerable
    {
#if UNITY_EDITOR
    ...
    public class SerializedDictionary<TKey, TValue> : ASerializedDictionary
    {
        ...
        private Dictionary<TKey, TValue> dictionary = null;
        ...
        private void InitialiseIfRequired()
        {
            ...
            GgLogs.Log(null, GgLogType.Debug, "Auto-initialising SerializedDictionary.");
            Initialise();
        }
        ...
        public bool TryGetKeysForValue(TValue value, out List<TKey> keys)
        {
            ...
            if (allValues.Count != allKeys.Count)
            {
