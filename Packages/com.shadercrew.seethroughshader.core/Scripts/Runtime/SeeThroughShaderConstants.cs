...
namespace ShaderCrew.SeeThroughShader
{
    public static class SeeThroughShaderConstants
    {
        ...
        /// URP 6.3///
        public static readonly string STS_SHADER_NAME_URP_UNITY6_3 = STS_SHADER_NAME_URP_FOLDER + "/Unity6_3" + STS_SHADER_NAME_LIT;
        ...
        /// HDRP 6.3///
        public static readonly string STS_SHADER_NAME_HDRP_UNITY6_3 = STS_SHADER_NAME_HDRP_FOLDER + "/Unity6_3" + STS_SHADER_NAME_LIT;
        ...
        /// URP 6.3///
        public static readonly string STS_SHADER_FILENAME_URP_UNITY6_3 = "/URP" + "/Unity6_3" + "/SeeThroughShader" + "_Lit" + "_URPUnity6_3";
        ...
        /// HDRP 6.3///
        public static readonly string STS_SHADER_FILENAME_HDRP_UNITY6_3 = "/HDRP" + "/Unity6_3" + "/SeeThroughShader" + "_Lit" + "_HDRPUnity6_3";
