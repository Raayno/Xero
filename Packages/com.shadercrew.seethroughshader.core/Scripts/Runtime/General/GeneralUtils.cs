...
namespace ShaderCrew.SeeThroughShader
{
    public static class GeneralUtils
    {
        ...
        "SeeThroughShader/HDRP/Unity6_3/Lit",
        ...
        "SeeThroughShader/URP/Unity6_3/Lit",
        ...
        public static readonly Dictionary<string,string> STS_HDRP_SHADER_DICTIONARY = new Dictionary<string, string>
        {
            ...
            { "HDRP/Lit", "SeeThroughShader/HDRP/Unity6_3/Lit" },
            { SeeThroughShaderConstants.STS_SHADER_DEFAULT_KEY, "SeeThroughShader/HDRP/Unity6_3/Lit" },
...
#if UNITY_6000_3_OR_NEWER
        { "URP/Lit", "SeeThroughShader/URP/Unity6_3/Lit" },
        { SeeThroughShaderConstants.STS_SHADER_DEFAULT_KEY, "SeeThroughShader/URP/Unity6_3/Lit" },
#elif UNITY_2023 || UNITY_6000
                ...
                if (GraphicsSettings.currentRenderPipeline.GetType().ToString().Contains("HighDefinition"))
                {
                    ...
                    else
                    {
                        if (unityVersion.StartsWith("6000"))
                        {
                            ...
                            {
                                shaderString = "SeeThroughShader/HDRP/Unity6_3/Lit";
                                shaderFolder = "SeeThroughShader/HDRP/Unity6_3/...";
                            }
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    else
                    {
                        if (unityVersion.StartsWith("6000"))
                        {
                            ...
                            {
                                shaderString = "SeeThroughShader/URP/Unity6_3/Lit";
                                shaderFolder = "SeeThroughShader/URP/Unity6_3/...";
                            }
                        } 
                        else
                        {
